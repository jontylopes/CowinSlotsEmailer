...
public class HomePage extends TestBase {
	...
	public void verifyVaccineSlots(String statep, String districtp, String costp, String vaccinep)
		...
		WebElement bydistrict = driver
				.findElement(By.xpath("//div[@class = 'mat-tab-label-content' ] [text()= 'By District']"));

		js.executeScript("arguments[0].click();", bydistrict);
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.id("mat-select-value-3")));
		...
		WebElement cost = driver
				.findElement(By.xpath("//div[@class='form-check']/label[contains(text(),'" + costp + "')]"));
		...
		List<WebElement> centres = driver
				.findElements(By.xpath("//div[@class='center-name-box']/h5[@class='center-name-title']"));
